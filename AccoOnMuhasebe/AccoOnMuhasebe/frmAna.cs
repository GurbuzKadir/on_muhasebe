    ...
    public partial class frmAna : DevExpress.XtraEditors.XtraForm
    {
        ...
        private void barButtonItem2_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            if (Application.OpenForms["frmDashboard"] == null)
            {
                ...
                frm_Dashboard.tip = yetki.ToString();
                frm_Dashboard.Show();
            }
        }
        ...
        private void frmAna_Load(object sender, EventArgs e)
        {
            ...
            if (yetki=="2")
            {
                btnPersoneller.Visibility = DevExpress.XtraBars.BarItemVisibility.Never;
                btnKasa.Visibility = DevExpress.XtraBars.BarItemVisibility.Never;
                btnGiderler.Visibility = DevExpress.XtraBars.BarItemVisibility.Never;
                btnRaporlar.Visibility = DevExpress.XtraBars.BarItemVisibility.Never;
