...
namespace AccoOnMuhasebe
{
    public partial class frmPersonel : Form
    {
        ...
        private void btnTamamla_Click(object sender, EventArgs e)
        {
            ...
            XtraMessageBox.AllowHtmlText = true;
            if (txtAd.Text.Trim().ToString() != null && txtAdres.Text.Trim().ToString() != null && txtMail.Text.Trim().ToString() != null && txtSoyad.Text.Trim().ToString() != null && txtTcKimlik.Text.Trim().ToString() != null && txtTelefon1.Text.Trim().ToString() != null && txtGorev.Text.Trim().ToString() != null && cmbIl.Text.Trim().ToString() != null && cmbIlce.Text.Trim().ToString() != null)
            {
