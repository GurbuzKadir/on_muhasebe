...
namespace AccoOnMuhasebe
{
    public partial class frmFirmalar : DevExpress.XtraEditors.XtraForm
    {
        ...
        private void btnKaydet_Click(object sender, EventArgs e)
        {
            ...
            if (txtAd.Text.Trim().ToString() != null &&txtSektor.Text.Trim().ToString() != null &&txtYetkili.Text.Trim().ToString() != null &&txtYetkiliGorev.Text.Trim().ToString() != null &&txtTcKimlik.Text.Trim().ToString() != null &&txtTelefon1.Text.Trim().ToString() != null &&txtMail.Text.Trim().ToString() != null &&cmbIl.Text.Trim().ToString() != null &&cmbIlce.Text.Trim().ToString() != null &&txtVergi.Text.Trim().ToString() != null &&txtAdres.Text.Trim().ToString() != null )
            {
                try
                {
