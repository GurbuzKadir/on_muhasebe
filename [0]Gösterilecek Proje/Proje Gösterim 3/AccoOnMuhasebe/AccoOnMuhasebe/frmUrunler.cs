...
namespace AccoOnMuhasebe
{
    public partial class frmUrunler : DevExpress.XtraEditors.XtraForm
    {
        ...
        private void btnKaydet_Click(object sender, EventArgs e)
        {
            ...
            if (txtAd.Text.Trim().ToString() != null && txtAlis.Text.Trim().ToString() != null && txtMarka.Text.Trim().ToString() != null && txtModel.Text.Trim().ToString() != null && txtSatis.Text.Trim().ToString() != null && txtYil.Text.Trim().ToString() != null && nudAdet.Value.ToString() != null)
            {
                try
                {
